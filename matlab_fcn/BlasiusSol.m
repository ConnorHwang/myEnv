function [y1i,y2i,y3i] = BlasiusSol(r,scconst,option)
% Based on the delta_0, Blasius viscous length scale (c.f., 2*delta_0).
...
% Interpolation
y1i = interp1(eta,y1,scconst*r,'pchip');
y2i = scconst*interp1(eta,y2,scconst*r,'pchip');
y3i = scconst^2*interp1(eta,y3,scconst*r,'pchip');
