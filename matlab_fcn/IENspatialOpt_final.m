function [M_growth, output1, output2] = ...
    IENspatialOpt_final(We, n, r, N1, L1, N2, L2, Eigenvectors, Eigenvalues, K, t, normtype)
%--------------------------------------------------------------------------
...
% B_ = sqrt(abs(real(Eigenvalues(cols)).^2+n^2-1)/We*2).';
% B_ = sqrt((Eigenvalues(cols).^2+n^2)/We).'; % original version
